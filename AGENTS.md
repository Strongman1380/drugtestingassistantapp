...
The Importance Score is a normalized 0–100 relevance metric indicating how critical a component is to the overall system. It is computed from three weighted factors: **functional centrality** (how many other components depend on it, 40%), **data criticality** (sensitivity and clinical significance of the data it handles, 35%), and **usage frequency** (how often the component is invoked during typical workflows, 25%). Threshold guidance: **> 75 = high** (core component, changes require careful review), **50–75 = medium** (supporting component), **< 50 = low** (peripheral or utility). For example, "85/100" is rated **high**, meaning the component is a core part of the system with significant downstream dependencies.
